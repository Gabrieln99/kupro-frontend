      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleRegister">
        ...
        <div class="flex items-center">
          ...
          <label for="agree-terms" class="ml-2 block text-sm text-gray-900">
            Slažem se s
            <a href="#" class="text-blue-600 hover:text-blue-500">Uvjetima korištenja</a>
            i
            <a href="#" class="text-blue-600 hover:text-blue-500">Politikom privatnosti</a>
          </label>
        </div>
        ...
        <div>
          ...
          >
            <span v-if="!isLoading">Registriraj se</span>
...
// Debug image loading
const imageError = () => {
  console.error('Image failed to load: /kupro_logo.png')
}

const imageLoaded = () => {
  console.log('Image loaded successfully: /kupro_logo.png')
}
</script>
